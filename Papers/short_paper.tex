...
\caption{The Die Hard specification rendered as a flat force-directed layout without clustering. With 16 states and 58 transitions, the layout degenerates, with no discernible structure. Compare with the clustered multi-view approach in Fig.~\ref{fig:splitview}.}
\label{fig:flat}
\end{figure}
