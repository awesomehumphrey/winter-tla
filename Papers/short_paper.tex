...
\title{Coordinated Graph and Matrix Views for TLA+ State Space Exploration: A Design Study}
...
The HourClock specification~\cite{lamport2003specifying} is a canonical TLA+ example: a single variable \texttt{hr} cycles through values 1 to 12 via one action, producing 12 states in a single cluster. Fig.~\ref{fig:hourclock_spec} shows the TLA+ specification.
