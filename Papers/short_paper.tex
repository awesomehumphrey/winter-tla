...
Our tool was developed through an iterative design process informed by our experience deploying TLA+ specifications in industry projects. Engineers in these projects who previously struggled to understand the TLA+ domain-specific language reported that visualisation of state spaces greatly assisted their understanding and use of the specifications. However, feedback from these engineers indicated that standard force-directed layouts became unreadable for specifications with more than approximately 20 states, directly motivating the multi-view approach presented in this paper. We followed the design study methodology described by Sedlmair et al.~\cite{sedlmair2012design}. Following Munzner's nested model~\cite{munzner2009nested}, our task analysis addresses the domain level, our data model addresses the abstraction level, and our view designs address the encoding level.
