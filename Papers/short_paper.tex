...
In prior industry deployments of TLA+ specifications, engineers who previously struggled with the domain-specific language reported that state space visualisation greatly assisted their understanding. Crucially, force-directed layouts became unreadable for specifications with more than approximately 20 states, directly motivating the multi-view approach presented here.
